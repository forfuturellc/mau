...
class FormSet {
     ...
     * @param  {SessionStore} [options.store] Session store
     * @param  {String} [options.prefix="query:"] Prefix for session ID
     * @param  {Number} [options.ttl] Time to live for the session
     */
    constructor(options={}) {
